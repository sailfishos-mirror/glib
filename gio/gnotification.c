 ...
 *
 * - [const@Gio.NOTIFICATION_CATEGORY_IM_MESSAGE]
 ...
 * - [const@Gio.NOTIFICATION_CATEGORY_CALL_MISSED]
 ...
 *
 * - [const@Gio.NOTIFICATION_BUTTON_PURPOSE_SYSTEM_CUSTOM_ALERT]
 * - [const@Gio.NOTIFICATION_BUTTON_PURPOSE_IM_REPLY_WITH_TEXT]
